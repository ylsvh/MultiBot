...
module.exports = {
    ...
    async execute(interaction, client) {
        const prefix =
            guildConfig.get(interaction.guild.id, "prefix") || "+";
        ...
        const rowInvite = new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder()
                    .setLabel("➕ Invite")
                    .setStyle(ButtonStyle.Link)
        ...
        const updateNav = commands => {
            rowNav.components[1].setDisabled(page === 0);
            rowNav.components[2].setDisabled(
                (page + 1) * perPage >= commands.length
            );
        };
