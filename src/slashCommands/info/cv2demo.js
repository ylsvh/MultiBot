...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('cv2demo')
        .setDescription('Démo des Components V2 Discord.'),
    ...
    async execute(interaction) {
        ...
        container.addTextDisplayComponents(
            new TextDisplayBuilder()
                .setContent(
                    '> **💡 Astuce :** Les composants peuvent être combinés dans n\'importe quel ordre. TextDisplay, galerie, boutons, etc.'
                )
        );
        ...
        container.addActionRowComponents(
            new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                    .setCustomId('cv2_primary')
                    .setLabel('Bouton Primaire')
                    .setStyle(ButtonStyle.Primary),

                new ButtonBuilder()
                    .setCustomId('cv2_success')
                    .setLabel('Succès')
                    .setStyle(ButtonStyle.Success),

                new ButtonBuilder()
                    .setCustomId('cv2_danger')
                    .setLabel('Danger')
